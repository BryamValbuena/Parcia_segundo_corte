...
void eliminarNodoConDosHijos(Nodo *&arbol, int numero) {
 ...
 int pesoHoja (Nodo* arbol){
    ...
    int pesoizq = pesoHoja (arbol -> izquierda);
    int pesoder = pesoHoja (arbol->derecha);
    return (pesoizq > pesoder)? pesoizq : pesoder;
}
...
void menu(){
    ...
    do
    {
        ...
        cout<<"5. MOSTRAR PESO DE LA ULTIMA HOJA \n";
        cout<<"6. SALIR \n";
        ...
        case 5:
            if(arbol != NULL){
                int peso = pesoHoja (arbol);
                cout<< "El peso de la ultima hoja es: " << peso << "\n";
            }else{
